...
{
    public abstract class SyntaxNodeComparerBase<T> : ISyntaxNodeComparer
        where T : SyntaxTreeNodeBase
    {
        public bool EqualsExceptChildren(SyntaxTreeNodeBase expected, SyntaxTreeNodeBase actual)
        {
            ...
            return NodesEquals((T)expected, (T)actual);
        }
        ...
        protected abstract bool NodesEquals(T actual, T expected);
    }
}
