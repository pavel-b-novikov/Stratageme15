...
{
    public interface IObjectEventTarget
    {
        /// <summary>
        ...
        /// </param>
        void AddEventListener(ObjectEventType type, EventDelegate<IEvent> listener, bool useCapture = false);
        ...
        /// If not specified, useCapture defaults to false.
        /// </param>
        void AddEventListener<TThis>(ObjectEventType type, ContextEventDelegate<TThis, IEvent> listener, bool useCapture = false);
    }
}
