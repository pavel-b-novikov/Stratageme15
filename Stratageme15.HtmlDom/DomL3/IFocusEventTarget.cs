namespace Stratageme15.HtmlDom.DomL3
{
    interface IFocusEventTarget
    {
        ...
        /// </param>
        void AddEventListener(FocusEventType type, EventDelegate<IFocusEvent> listener, bool useCapture = false);
        ...
        /// If not specified, useCapture defaults to false.
        /// </param>
        void AddEventListener<TThis>(FocusEventType type, ContextEventDelegate<TThis, IFocusEvent> listener, bool useCapture = false);
    }
}
