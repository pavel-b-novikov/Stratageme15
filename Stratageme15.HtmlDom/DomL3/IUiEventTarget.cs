namespace Stratageme15.HtmlDom.DomL3
{
    public interface IUiEventTarget
    {
        ...
        /// </param>
        void AddEventListener(DomEventType type, EventDelegate<IUiEvent> listener, bool useCapture = false);
        ...
        /// If not specified, useCapture defaults to false.
        /// </param>
        void AddEventListener<TThis>(DomEventType type, ContextEventDelegate<TThis,IUiEvent> listener, bool useCapture = false);
    }
}
