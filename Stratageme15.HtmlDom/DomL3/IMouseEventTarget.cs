namespace Stratageme15.HtmlDom.DomL3
{
    public interface IMouseEventTarget
    {
        ...
        /// </param>
        void AddEventListener(MouseEventType type, EventDelegate<IMouseEvent> listener, bool useCapture = false);
        ...
        /// If not specified, useCapture defaults to false.
        /// </param>
        void AddEventListener<TThis>(MouseEventType type, ContextEventDelegate<TThis, IMouseEvent> listener, bool useCapture = false);
    }
}
