...
{
    public interface IFramesetEventTarget
    {
        /// <summary>
        ...
        /// </param>
        void AddEventListener(FramesetEventType type, EventDelegate<IEvent> listener, bool useCapture = false);
        ...
        /// If not specified, useCapture defaults to false.
        /// </param>
        void AddEventListener<TThis>(FramesetEventType type, ContextEventDelegate<TThis, IEvent> listener, bool useCapture = false);
    }
}
