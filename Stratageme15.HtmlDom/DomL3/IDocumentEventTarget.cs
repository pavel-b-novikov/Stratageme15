...
{
    public interface IDocumentEventTarget
    {
        /// <summary>
        ...
        /// </param>
        void AddEventListener(DocumentEventType type, EventDelegate<IEvent> listener, bool useCapture = false);
        ...
        /// If not specified, useCapture defaults to false.
        /// </param>
        void AddEventListener<TThis>(DocumentEventType type, ContextEventDelegate<TThis, IEvent> listener, bool useCapture = false);
    }
}
