namespace Stratageme15.HtmlDom.Gamepad
{
    interface IGamepadEventTarget
    {
        ...
        /// </param>
        void AddEventListener(GamepadEventType type, EventDelegate<IGamepadEvent> listener, bool useCapture = false);
        ...
        /// If not specified, useCapture defaults to false.
        /// </param>
        void AddEventListener<TThis>(GamepadEventType type, ContextEventDelegate<TThis, IGamepadEvent> listener, bool useCapture = false);
    }
}
