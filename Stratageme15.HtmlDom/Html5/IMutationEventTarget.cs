...
{
    public interface IMutationEventTarget
    {
        /// <summary>
        ...
        /// </param>
        void AddEventListener(MutationEventType type, EventDelegate<IMutationEvent> listener, bool useCapture = false);
        ...
        /// If not specified, useCapture defaults to false.
        /// </param>
        void AddEventListener<TThis>(MutationEventType type, ContextEventDelegate<TThis, IMutationEvent> listener, bool useCapture = false);
    }
}
