...
{
    public interface IFormEventTarget
    {
        /// <summary>
        ...
        /// </param>
        void AddEventListener(FormEventType type, EventDelegate<IEvent> listener, bool useCapture = false);
        ...
        /// If not specified, useCapture defaults to false.
        /// </param>
        void AddEventListener<TThis>(FormEventType type, ContextEventDelegate<TThis, IEvent> listener, bool useCapture = false);
    }
}
