...
namespace Stratageme15.HtmlDom.Html5
{
    public interface IChangeEventTarget
    {
        ...
        /// </param>
        void AddEventListener(ChangeEventType type, EventDelegate<IEvent> listener, bool useCapture = false);
        ...
        /// If not specified, useCapture defaults to false.
        /// </param>
        void AddEventListener<TThis>(ChangeEventType type, ContextEventDelegate<TThis, IEvent> listener, bool useCapture = false);
    }
}
